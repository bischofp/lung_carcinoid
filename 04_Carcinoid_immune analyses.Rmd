...
lympho_counts_tbl_refined <- lympho_counts %>%
  dplyr::count(cell_type_imm_refined, patient_id, tissue_type)
write_csv(lympho_counts_tbl_refined, path = "output/tables/lympho_counts_refined.csv")
...
myelo_counts_tbl_refined <- myelo_counts %>%
  dplyr::count(cell_type_imm_refined, patient_id, tissue_type)
write_csv(myelo_counts_tbl_refined, path = "output/tables/myelo_counts_refined.csv")
